                        ...
                        {props.isMobile ? null :
                            <Stack alignItems="center">
                                <Box width="150px" height="175px">
                                    <CardMedia
                                        component="img"
                                        image={(props.equipment.imageUrl === undefined || props.equipment.imageUrl == null || props.equipment.imageUrl === "") ? import.meta.env.PUBLIC_URL + "/shed_acronym_vert.jpg" : "" + import.meta.env.VITE_CDN_URL + import.meta.env.VITE_CDN_EQUIPMENT_DIR + "/" + props.equipment.imageUrl}
